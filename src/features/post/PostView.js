...
import { Card, Radio, Typography, Avatar, Button, Comment, Tooltip, List, Input, Form } from 'antd';
    ...
    <div className="post-post-view">
      <Card >
            ...
            <div>
              <Radio.Group onChange={onRadioChange} value={checkedValue}>
                {_.map(_.keys(postDetail.content), key => {
                  return <Radio className="post-post-view-content" value={key}>{postDetail.content[key]}</Radio>
                })}
              </Radio.Group>
              <Button type="primary" className="post-post-view-submit">Partager mon avis</Button>
        ...
        <Typography.Text className="post-post-view-auther" type="secondary">
          ( Publié par &nbsp;<Avatar src={autherDetail.url} icon={<UserOutlined />} size={30} /> {autherDetail.userName} )
        </Typography.Text>
      </Card>
